...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	 ...
	 * @generated
	 */
	public EReference getLibrary_Nonfiction() {
	 ...
	 * @generated
	 */
	public EReference getLibrary_Fiction() {
	...
	public void createPackageContents() {
		...
		createEReference(libraryEClass, LIBRARY__NONFICTION);
		createEReference(libraryEClass, LIBRARY__FICTION);
	...
	public void initializePackageContents() {
		...
		initEReference(getLibrary_Nonfiction(), this.getNonFiction(), null, "nonfiction", null, 0, 1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLibrary_Fiction(), this.getFiction(), null, "fiction", null, 0, 1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
