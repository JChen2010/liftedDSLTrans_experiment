 ...
 * <ul>
 *   <li>{@link hierarchy.impl.BookImpl#getName <em>Name</em>}</li>
 *   <li>{@link hierarchy.impl.BookImpl#getGenre <em>Genre</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BookImpl extends EObjectImpl implements Book
{
  ...
  {
    return HierarchyPackage.Literals.BOOK;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HierarchyPackage.BOOK__NAME, oldName, name));
  }
  ...
  public void setGenre(String newGenre)
  {
    ...
    genre = newGenre;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HierarchyPackage.BOOK__GENRE, oldGenre, genre));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HierarchyPackage.BOOK__NAME:
        return getName();
      case HierarchyPackage.BOOK__GENRE:
        return getGenre();
    }
