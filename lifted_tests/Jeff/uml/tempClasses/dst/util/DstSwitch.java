...
public class DstSwitch
{
  ...
  protected Object doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case DstPackage.CLASS:
      {
        dst.Class class_ = (dst.Class)theEObject;
        Object result = caseClass(class_);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DstPackage.PROPERTY:
      {
      ...
      case DstPackage.GENERALIZATION:
      {
