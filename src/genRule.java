...
import transformerProcessor.*;
import transformerProcessor.exceptions.*;
...
//	Execute DSLTrans transformation at rpath in project dir path.
	public static void executeRule(String rpath, String path) {
		...
		File transformation = new File(TRANS);
...
*/
	public static int genCreate(String pname, String cname, String ptype, String ctype, String aname, String root, String rtype, String rname, String mode)
	{
		try {
...
// NOTE: must not have a output.xmi present in directory prior to running
	public static int genMove(String cname, String ptype, String ctype, String daname, String caname, String root, String rtype, String rname) {
		...
		if(ptype.equals("Model")) {
			genCreate("bCMS", cname, ptype, ctype, caname, root, rtype, rname, "r");
		}
		else {
			genCreate("DONOTMATCHTHIS", cname, ptype, ctype, caname, root, rtype, rname, "e");
		}
...
*/
	...
	public static void main(String[] args) {
		...
		*/
		...
		if(args[0].equals("c")) {
			genCreate(args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9]);
			...
			genMove(args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8]);
		}
	}
}